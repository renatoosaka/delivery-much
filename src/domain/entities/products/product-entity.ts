...
export class Product {
  ...
  static create(data: ProductData): Either<RequiredValueError | MoreThanZeroError, Product> {
    ...
    return right(new Product( nameOrError.value, priceOrError.value, quantityOrError.value ))
  }
}